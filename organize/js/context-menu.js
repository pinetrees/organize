$(function () {
    ...
    function rename() {
      ...
      $.post('process.php', { action: 'rename', ID: $ID, name: val, parent: $parent.attr('data-id'), type: $parent.attr('data-type') }, function(res) {
        console.log(res);
    ...
    function obdelete() {
      ...
      if( multiselect == true ) return $.post('process.php', { action: 'multidelete', IDs: selection }, function(res) {
	...
	multiselect = false;
      ...
      $.post('process.php', { action: 'delete', ID: $ID, name: $val, parent: $parent.attr('data-id'), type: $parent.attr('data-type') }, function(res) {
	console.log(new Date().getTime() - time);
	console.log(res);
    ...
    function obcomplete() {
      ...
      $.post('process.php', { action: 'complete', ID: $ID }, function(res) { console.log(res); element.css('background', 'lightgreen'); });
    ...
    $('.style .color').click( function() {
      ...
      $.post('process.php', { action: 'style', ID: $ID, attribute: attribute, value: value }, function(res){console.log(res); element.css(attribute, value)});
    });
    ...
    $('.type-option').click(function() {
      ...
      console.log($ID);
      $.post('process.php', { action: 'type', ID: $ID, type: type }, function(res){
        console.log(res);
    ...
    $('.class-option').click(function() {
      ...
      console.log($ID);
      $.post('process.php', { action: 'class', ID: $ID, classification: classification }, function(res){
        console.log(res);
    ...
    $('.field-option').click(function() {
      ...
      $.post('process.php', { action: 'addfield', ID: $ID, field: field }, function(res){
        console.log(res);
      });
    });

...
CREATE TABLE `objects` (
  ...
  `type` varchar(32) DEFAULT 'object',
  `classes` varchar(255) DEFAULT 'a:0:{}',
  `time` int(11) DEFAULT '0',
  `fields` varchar(255) DEFAULT 'a:0:{}',
  `value` decimal(2,0) DEFAULT '0',
  PRIMARY KEY (`ID`)
...
-- Dump completed on 2014-07-18 20:52:23
